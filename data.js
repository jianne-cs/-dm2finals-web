...
const GATE_SONGS = [
    { index: 0, name: 'NAND', song: 'Ave Mujica', file: 'nand - Ave Mujica.mp3' },
    { index: 1, name: 'AND', song: 'Sophie', file: 'and - Sophie.mp3' },
    { index: 2, name: 'NOR', song: 'Deep Into The Forest', file: 'nor- ~Deep Into The Forest~.mp3' },
    { index: 3, name: 'XOR', song: 'KiLLKiSS', file: 'xor - KiLLKiSS.mp3' },
    { index: 4, name: 'OR', song: 'KuroNoBirthday', file: 'or - KuroNoBirthday.mp3' },
    { index: 5, name: 'Implication', song: 'Crucifix X', file: 'implication - Crucifix X.mp3' },
    { index: 6, name: 'XNOR', song: 'Georgette Me, Georgette You', file: 'xor  - Georgette Me, Georgette You.mp3' },
    { index: 7, name: 'Negation', song: 'Inversus', file: 'negation - Ether.mp3' },
    { index: 8, name: 'Tautology', song: 'Octagram Dance', file: 'Tautology - Octagram Dance.mp3' },
    { index: 9, name: 'Contradiction', song: 'Imprisoned XII', file: 'contradiction- Imprisoned XII.mp3' },
    { index: 10, name: 'Converse Implication', song: 'Symbol I', file: 'converse implication - Symbol I _ △_Fire.mp3' },
    { index: 11, name: 'Material Nonimplication', song: 'Symbol III', file: 'material nonimplication - Symbol III _ ▽.mp3' },
    { index: 12, name: 'Converse Nonimplication', song: 'Symbol IV', file: 'converse nonimplication - Symbol IV _ Earth.mp3' },
    { index: 13, name: 'Projection P', song: 'Alter Ego', file: 'Projection of P- Alter Ego.mp3' },
    { index: 14, name: 'Projection Q', song: 'DIVINE', file: 'projection of q - DIVINE.mp3' },
    { index: 15, name: 'Negation of Q', song: 'Ether', file: 'negation of q -Ether.mp3' }
];
...
const CHARACTER_SONG_MAP = {
    ...
    mutsumi: { song: "Choir 'S' Choir", file: "Ave Mujica - Choir 'S' Choir (Official Music Video).mp3" },
    umiri: { song: "'S/' The Way", file: "Ave Mujica- 'S' The Way.mp3" },
